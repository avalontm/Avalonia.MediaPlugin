...
namespace Avalonia.MediaPlugin.Android
{
    ...
    public class MediaPickerActivity : Activity, IOnScanCompletedListener
    {
            ...
            try
            {
                ...
                else
                {
                    if (!isPhoto)
                    {
                        ...
                        try
                        {
                            var name = Settings.System.GetString(App.Context.ContentResolver, "device_name");
                    ...
                    if (!ran)
                    {
                        ...
                        if (path.Scheme == "file")
                        {
                            try
                            {
                                var photoURI = FileProvider.GetUriForFile(this, App.Context.PackageName + ".fileprovider", new Java.IO.File(path.Path));
