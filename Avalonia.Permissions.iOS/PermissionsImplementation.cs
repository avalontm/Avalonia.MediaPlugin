...
namespace Avalonia.Permissions.iOS
{
    /// <summary>
    ...
    public class PermissionsImplementation : IPermissions
    {
        ...
        public Task<PermissionStatus> CheckPermissionStatusAsync(Permission permission)
        {
            switch (permission)
            {
                ...
                case Permission.Camera:
                    return Task.FromResult(GetAVPermissionStatus(AVAuthorizationMediaType.Video));
                ...
                case Permission.Microphone:
                    return Task.FromResult(GetAVPermissionStatus(AVAuthorizationMediaType.Audio));
            ...
            foreach (var permission in permissions)
            {
                ...
                switch (permission)
                {
                    case Permission.Calendar:
                        ...
                        break;
                    case Permission.Camera:
                        results.Add(permission, await RequestAVPermissionStatusAsync(AVAuthorizationMediaType.Video));
                        break;
                    case Permission.Contacts:
                    ...
                    case Permission.MediaLibrary:
                        ...
                        break;
                    case Permission.Microphone:
                        results.Add(permission, await RequestAVPermissionStatusAsync(AVAuthorizationMediaType.Audio));
                        break;
                    case Permission.Photos:
        ...
        internal static async Task<PermissionStatus> RequestAVPermissionStatusAsync(AVAuthorizationMediaType mediaType)
        {
#if __IOS__
            try
            {
        ...
        internal static PermissionStatus GetAVPermissionStatus(AVAuthorizationMediaType mediaType)
        {
#if __IOS__
